...
function Navbar() {
  ...
  return (
    ...
    >
      ...
      {isDropdownOpen && (
        <div
          className="fixed right-4 mt-2 w-56 bg-white rounded-xl shadow-lg py-1 z-50 border border-gray-100 overflow-hidden"
          ref={dropdownRef}
        >
          <div
            className="flex items-center px-4 py-3 rounded-lg text-base font-medium text-gray-700 hover:text-indigo-600 hover:bg-indigo-50 transition-colors cursor-pointer"
            onClick={() => {
              closeMenu();
              setIsDropdownOpen(false);
              navigate('/setting');
